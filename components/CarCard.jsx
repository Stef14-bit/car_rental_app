...
const CarCard = ({
  ...
  return (
    <div className="flex flex-col bg-gray-100 ml-5 mr-5 mb-10  border-4 border-indigo-500 shadow-lg shadow-indigo-500/75  ">
      ...
      <Link
        ...
        target="_blank"
      >
        <button className=" bg-sky-400 w-2/3 h-10 rounded-full text-white font-semibold ml-14 mb-4 shadow-lg shadow-indigo-500/50">
          Rent
        </button>
      </Link>
    </div>
